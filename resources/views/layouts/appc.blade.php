            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active mx-4">
                        <a class="nav-link" href="{{route('crear_oferta')}}">Publicar una oferta<span class=" sr-only ">(current)</span></a>
                    </li>

                    <li class="nav-item mx-4">
                        <a class="nav-link " href="{{route('postulantes')}}">Ver postulantes</a>
                    </li>

                    <li class="nav-item active mx-4">
                        <a class="nav-link" href="{{route('editar_empresa')}}">Mi perfil<span class=" sr-only ">(current)</span></a>
                    </li>
                </ul>
